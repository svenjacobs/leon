...
class YoutubeRedirectSanitizerRegistration @Inject constructor(
	private val sanitizerProvider: Provider<YoutubeRedirectSanitizer>,
	...
	override fun getName(context: Context) =
		context.getString(R.string.feat_sanitizer_youtube_redirect_name)

	override fun matchesDomain(input: String) = DOMAIN_REGEX.containsMatchIn(input)

	private companion object {
		private val DOMAIN_REGEX = Regex("youtube\\.com/redirect")
	}
}
