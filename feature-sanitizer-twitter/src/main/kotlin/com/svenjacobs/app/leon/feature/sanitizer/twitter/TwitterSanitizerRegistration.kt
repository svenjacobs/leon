...
class TwitterSanitizerRegistration(
	private val sanitizerProvider: () -> TwitterSanitizer = { TwitterSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.feat_sanitizer_twitter_name)
