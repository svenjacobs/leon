...
class NetflixSanitizerRegistration @Inject constructor(
	private val sanitizerProvider: Provider<NetflixSanitizer>,
	...
	override fun getName(context: Context) = context.getString(R.string.feat_sanitizer_netflix_name)
