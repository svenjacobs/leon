...
class AolSearchSanitizerRegistration(
	private val sanitizerProvider: () -> AolSearchSanitizer = { AolSearchSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.sanitizer_aol_search_name)
