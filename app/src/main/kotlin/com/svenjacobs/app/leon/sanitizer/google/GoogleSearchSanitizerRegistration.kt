...
class GoogleSearchSanitizerRegistration(
	private val sanitizerProvider: () -> GoogleSearchSanitizer = { GoogleSearchSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.sanitizer_google_search_name)
