...
class GoogleAnalyticsSanitizerRegistration(
	private val sanitizerProvider: () -> GoogleAnalyticsSanitizer = { GoogleAnalyticsSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.sanitizer_ga_name)
}
