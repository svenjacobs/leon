...
package com.svenjacobs.app.leon.sanitizer.flipkart
...
class FlipkartSanitizerRegistration(
	private val sanitizerProvider: () -> FlipkartSanitizer = { FlipkartSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.sanitizer_flipkart_name)
