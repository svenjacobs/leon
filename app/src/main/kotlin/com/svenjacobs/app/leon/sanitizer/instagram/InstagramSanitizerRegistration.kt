...
class InstagramSanitizerRegistration(
	private val sanitizerProvider: () -> InstagramSanitizer = { InstagramSanitizer() },
	...
	override fun getName(context: Context) = context.getString(R.string.sanitizer_instagram_name)
