...
import com.svenjacobs.app.leon.domain.Defaults.Netflix
import com.svenjacobs.app.leon.test.MOCK_SANITIZER_STRATEGY_EXECUTOR
import io.kotest.core.spec.style.ShouldSpec
import io.kotest.matchers.be
import io.kotest.matchers.should

class NetflixSanitizerTest : ShouldSpec({

    context("sanitize") {

        should("remove various Netflix parameters") {
            ...
            result.artifactsRemoved should be(5)
            result.output should be("https://www.netflix.com/de/title/81040344")
        }
    }
})
