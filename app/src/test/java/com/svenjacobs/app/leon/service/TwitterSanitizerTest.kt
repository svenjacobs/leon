...
import com.svenjacobs.app.leon.domain.Defaults.Twitter
import com.svenjacobs.app.leon.test.MOCK_SANITIZER_STRATEGY_EXECUTOR
import io.kotest.core.spec.style.ShouldSpec
import io.kotest.matchers.be
import io.kotest.matchers.should

class TwitterSanitizerTest : ShouldSpec({

    context("sanitize") {

        should("remove the \"s\" and \"t\" parameters") {
            ...
            result.output should be("https://twitter.com/AndroidDev/status/1453763770334027781")
        }
    }
})
